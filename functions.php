...
{
    $chunks = array(
        array(24 * 60 * 60, ' Gün önce'),
        array(60 * 60, ' Saat önce'),
...
function newgravatar($avatar_defaults)
{
    ...
    $avatar_defaults[$myavatar] = "Tony teması varsayılan avatarı";
